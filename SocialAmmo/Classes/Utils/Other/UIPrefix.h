...
#define _ButtonWithTag(view, tag)		((UIButton*)[view viewWithTag:tag])
#define _TextFieldWithTag(view, tag)	((UITextField*)[view viewWithTag:tag])
#define _SwitchWithTag(view, tag)		((UISwitch*)[view viewWithTag:tag])
#define _SliderWithTag(view, tag)		((UISlider*)[view viewWithTag:tag])

#define _TableWithTag(view, tag)		((UITableView*)[view viewWithTag:tag])
...
#define ImagePathForDocs(fileName)	[DocumentDirPath stringByAppendingPathComponent:fileName]
#define isFileInDocs(filePath)		[[NSFileManager defaultManager] fileExistsAtPath:filePath]